...
function SystemHealthStatesPanel({ txt, systemHealth }) {
  const active = systemHealth;

  return (
    <div className={styles.systemHealthStatesPanelWrapper}>
      <h2 className={styles.systemHealthStatesPanelTitle}>{txt.systemStateTitle['pt']}</h2>
